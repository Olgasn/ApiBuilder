Программный комплекс для автоматизированного формирования серверных ASP .NET Core приложений с задаваемой архитектурой на базе настраиваемых шаблонов. Программный комплекс предоставляет функционал для автоматизированного формирования базовых модулей приложений на основе пользовательских настроек. Для удобства использования приложения был разработан графический ользовательский интерфейс.

Приложение обладает следующим функционалом:
автоматическое формирования решения на основе выбранных пользователем конфигураций;
автоматическое формирования проектов на основе выбранных пользователем конфигураций;
автоматическое формирования классов на основе выбранных пользователем конфигураций и доменной области;
автоматическое формирования SQL подключения и миграций на основе выбранных пользователем конфигураций;
пользовательская настройка конфигурационных файлов;
простой и интуитивно понятный интерфейс для пользователей, с возможностью локализации на русский язык и переводом на другие языки.


# DesktopApiBuilder
Программный комплекс предазначени для автоматизированного формирования серверных ASP .NET Core приложений с задаваемой архитектурой на базе настраиваемых шаблонов. Программный комплекс предоставляет функционал для автоматизированного формирования базовых модулей приложений на основе пользовательских настроек. Для удобства использования приложения был разработан графический ользовательский интерфейс.
...
SQL подключения и миграции на основе выбранных пользователем конфигураций;

unit- тесты.


Пользовательская настройка выполняется с помощью конфигурационных файлов.
