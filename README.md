Программный комплекс для автоматизированного формирования серверных ASP .NET Core приложений с задаваемой архитектурой на базе настраивае-мых шаблонов. Программный комплекс предоставляет функционал для ав-томатизированного формирования базовых модулей приложений на основе пользовательских настроек. Для удобства использования приложения был разработан интуитивно понятный пользовательский интерфейс.

Приложение обладает следующим функционалом:
автоматическое формирования решения на основе выбранных поль-зователем конфигураций;
автоматическое формирования проектов на основе выбранных поль-зователем конфигураций;
автоматическое формирования классов на основе выбранных поль-зователем конфигураций и доменной области;
автоматическое формирования SQL подключения и миграций на ос-нове выбранных пользователем конфигураций;
пользовательская настройка конфигурационных файлов;
простой и интуитивно понятный интерфейс для пользователей, с воз-можностью локализации на русский язык и переводом на другие языки.
